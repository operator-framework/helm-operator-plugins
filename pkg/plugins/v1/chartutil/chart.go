...
func (opts CreateOptions) Resource() resource.Resource {
	return resource.Resource{
		...
		Plural: resource.RegularPlural(opts.GVK.Kind),
	}
}
...
// creating the chart.
func CreateChart(projectDir string, opts CreateOptions) (*resource.Resource, *chart.Chart, error) {
...
func scaffoldChart(destDir string, opts CreateOptions) (*resource.Resource, *chart.Chart, error) {
	r := opts.Resource()
...
func fetchChart(destDir string, opts CreateOptions) (*resource.Resource, *chart.Chart, error) {
	var (
		chart *chart.Chart
		err   error
	)
