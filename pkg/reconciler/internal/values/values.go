...
// Values represent the release/CR values which are equivalent to the chart.values
type Values struct {
	m map[string]interface{}
}

// FromUnstructured return teh Values from an Release/CR
...
// New create a new Values structure
func New(m map[string]interface{}) *Values {
	return &Values{m: m}
}

// Map return the map[string]interface{} from the Values
...
// Mapper values represent chart the values
